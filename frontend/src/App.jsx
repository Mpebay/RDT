...
function WhatsAppButton() {
  ...
  // Si el usuario ya inició sesión, no renderizamos el botón
  if (userInfo) return null;

  return (
    <a
      href="https://wa.me/5491100000000?text=Hola,%20tengo%20dudas%20sobre%20los%20cursos%20de%20El%20Rincón%20del%20Trading"
      target="_blank"
...
function Navbar() {
  ...
  const logoutHandler = () => {
    ...
    localStorage.removeItem('token'); // Aseguramos limpiar también el token
    navigate('/');
    window.location.reload(); // Recargamos para actualizar el estado visual
  };
